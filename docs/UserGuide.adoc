...
to your Ark software, head https://core.telegram.org/bots#6-botfather[here] to learn how to retrieve an Authorization
...
1. Retrieve Authorization Token from https://core.telegram.org/bots#6-botfather[Botfather].
* Your token should look something like this: `458231237:AAEPeghjklUxY7GHnYiJ5c0y-IldALLI0FE`
2. Initialize Ark.jar to generate the default configuration file, config.json.
...
image::sampleConfigFileSelected.png[width="600"]
_Figure 6.19.2.1 : Sample Configuration File with Telegram Bot Authorization Token field highlighted._

After which, enter the authorization token into
...
_Figure 6.21.3.1: Sample interaction of sending QR code to ArkBot_
