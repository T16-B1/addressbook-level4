...
*Input:* `/find Meier` +
*Expected output:* ArkBot should show a list of uncompleted parcels that have “Meier” in their names + Changes reflected in Ark as well.
...
*Input:* `/complete`, [upload QR code image] +
*Expected output:* ArkBot shows parcel completion message. +

image::sampleQR.png[width="600"]
